...
public class RequestQueue {
    ...
    /**
     * 功能描述: 获取单例的请求内存队列<br>
     * @return: com.eshopinventory.inventory.manage.item.request.RequestQueue
     * @since: 1.0.0
     * @Author: Administrator
     ...
     * @return: java.util.concurrent.ArrayBlockingQueue<com.eshopinventory.inventory.manage.item.request.Request>
     * @since: 1.0.0
     * @Author: Administrator
