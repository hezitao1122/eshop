...
@EntityScan({"com.didispace.scca.core.domain","com.didispace.scca.rest.domain"})
@EnableJpaRepositories(basePackages = {"com.didispace.scca.core.domain","com.didispace.scca.rest.domain"})
