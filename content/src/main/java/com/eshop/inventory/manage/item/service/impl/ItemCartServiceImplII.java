...
import com.eshop.inventory.manage.item.service.ItemCartServiceII;
 ...
 * ```````````````````````````
 * @title: ItemCartServiceImplII
 * @projectName inventory
 * @date 2019/6/17 22:14
 */
@Service
public class ItemCartServiceImplII extends IIBaseDBAndCacheServiceImpl<TbItemCat,Long> implements ItemCartServiceII {
