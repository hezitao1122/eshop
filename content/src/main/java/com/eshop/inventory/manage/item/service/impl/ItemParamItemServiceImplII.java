...
import com.eshop.inventory.manage.item.service.ItemParamItemServiceII;
 ...
 * ```````````````````````````
 * @title: ItemParamItemServiceImplII
 * @projectName inventory
 * @date 2019/6/17 22:41
 */
@Service
public class ItemParamItemServiceImplII extends IIBaseDBAndCacheServiceImpl<TbItemParamItem,Long> implements ItemParamItemServiceII {
    @Autowired
