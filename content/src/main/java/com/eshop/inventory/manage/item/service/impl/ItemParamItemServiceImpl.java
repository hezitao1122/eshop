...
import com.eshop.inventory.manage.item.service.ItemParamItemService;
 ...
 */
@Service
public class ItemParamItemServiceImpl extends BaseDBAndCacheServiceImpl<TbItemParamItem,Long> implements ItemParamItemService {
    @Autowired
