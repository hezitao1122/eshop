...
import com.eshop.inventory.manage.item.service.ItemParamServiceII;
 ...
 * ```````````````````````````
 * @title: ItemParamServiceImplII
 * @projectName inventory
 * @date 2019/6/17 22:31
 */
@Service
public class ItemParamServiceImplII extends IIBaseDBAndCacheServiceImpl<TbItemParam,Long> implements ItemParamServiceII {
    @Autowired
