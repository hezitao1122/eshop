...
/**
 * @author zeryts
 * @description: 系统参数规则推送至redis的操作
 * -----------------------------------
 * @title: SystemRuleRedisPublisher
 * @projectName amap
 * @date 2019/8/23 15:53
 */
@Component(value = "systemRuleRedisPublisher")
public class SystemRuleRedisPublisher implements DynamicRulePublisher<List<SystemRuleEntity>> {
    ...
    public void publish(String app, List<SystemRuleEntity> rules) throws Exception {
        ...
        stringRedisTemplate.opsForValue().set(RuleConsts.RULE_SYSTEM + app, strs);
        //成功的话同步至数据库
        service.updateByAppAndType(app,RuleConsts.RULE_SYSTEM,strs);
        //成功的话再发送channel消息
        stringRedisTemplate.convertAndSend(RuleConsts.RULE_SYSTEM_CHANNEL + app , strs);
    }
}
